package com.hhyun.customalertlibrary.ui.shadow
...
import com.hhyun.customalertlibrary.R
...
//        super.setBackgroundResource(resId)
    ...
    fun setVisibilityShadow(isShow: Boolean) {
        ...
        if(isShow) {
            ...
            this.background = ContextCompat.getDrawable(context, R.drawable.hhyunlib_transparent).apply {
                setPadding(initPaddingLeft, initPaddingTop, initPaddingRight, initPaddingBottom)
            }
        }
    }
